        ...
        <div className="space-y-6">
            ...
            <div className="rounded-full bg-surface-dark p-1">
              <div className="grid grid-cols-3 gap-1">
                ...
                >
                  ...
                  <span
                    className={`relative z-10 ${state.fogFrequency === "frequently" ? "text-background-dark" : "text-white/65"}`}
                  >
                    Frequently
                  </span>
                </button>
                <button
                  className="relative rounded-full px-3 py-2.5 text-sm font-black"
                  onClick={() =>
                    void setState({ fogFrequency: "occasionally" })
                  }
                >
                  ...
                  <span
                    className={`relative z-10 ${state.fogFrequency === "occasionally" ? "text-background-dark" : "text-white/65"}`}
                  >
                    Occasionally
                  </span>
                </button>
                ...
                >
                  ...
                  <span
                    className={`relative z-10 ${state.fogFrequency === "no" ? "text-background-dark" : "text-white/65"}`}
                  >
                    No
                  </span>
                </button>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <OptionButton
                active={state.speed === "0-50"}
                onClick={() => void setState({ speed: "0-50" })}
                label="0-50 km/h"
              />
              <OptionButton
                active={state.speed === "50-80"}
                onClick={() => void setState({ speed: "50-80" })}
                label="50-80 km/h"
              />
              <OptionButton
                active={state.speed === "80-100"}
                onClick={() => void setState({ speed: "80-100" })}
                label="80-100 km/h"
              />
              <OptionButton
                active={state.speed === "100-140"}
                onClick={() => void setState({ speed: "100-140" })}
                label="100-140 km/h"
              />
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      value={state.leftEye}
                      onChange={(event) =>
                        void setState({ leftEye: event.target.value })
                      }
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        void setState({ rightEye: event.target.value })
                      }
                    />
                  </div>
                </div>
